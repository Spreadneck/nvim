return {
  ...
  },
  {
    ...
    opts = {
      ...
      ensure_installed = {
        "bashls", "cssls", "dockerls", "gopls", "html",
        "jsonls", "pyright", "vimls", "yamlls", "ansiblels",
        "marksman", "lua_ls", "texlab"
      },
    },
...

{
  ...
  opts = {
    ensure_installed = {
      "prettier", "stylua", "eslint", "shellcheck", "shfmt",
      "black", "ruff", "isort", "markdownlint", "yamllint", "ansiblelint"
    },
  },
  config = function(_, opts)
